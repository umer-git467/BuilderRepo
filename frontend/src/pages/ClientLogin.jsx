...
function ClientLogin() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            const response = await axios.post("https://builder-repo-3zcu-neeryxas9-umer-git467s-projects.vercel.app/login-Client", {
                email,
                password,
            });
                    ...
                    <div className="flex items-center justify-center bg-gradient-to-l from-blue-500 to-purple-600">
                        <div className="flex w-full max-w-6xl bg-gray-200 rounded-lg shadow-2xl overflow-hidden">
                            <div className="w-1/2 p-8 relative">
                                <Link to="/sign-in">
                                <BsArrowLeft
                                    className="absolute top-4 left-4 text-2xl cursor-pointer text-gray-600 hover:text-gray-800"/>
                                </Link>
